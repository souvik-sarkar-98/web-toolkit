...
```bash
npm install @web-toolkit/comment-core @web-toolkit/comment-angular
```
...
```ts
import { MENTION_USER_SEARCH } from '@web-toolkit/comment-angular';
...
```bash
npm run build -w @web-toolkit/comment-angular
```
