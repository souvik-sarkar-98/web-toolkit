export declare const CUSTOM_FIELD_TYPES: readonly ["text", "textarea", "email", "phone", "number", "boolean", "toggle", "date", "date_range", "select", "multiselect", "autocomplete", "password"];
...
export type CustomFieldValueParsed = string | number | boolean | string[] | DateRangeValue | null;
