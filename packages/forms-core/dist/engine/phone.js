...
export function normalizePhoneCountryCode(raw) {
...
export function resolveDefaultPhoneCountryCode(options) {
    return normalizePhoneCountryCode(options?.defaultPhoneCountryCode ?? DEFAULT_DIAL_CODE);
}
export function resolvePhoneCountryCodeOptions(options) {
...
export function formatPhoneFieldValue(countryCode, nationalNumber) {
...
export function parsePhoneFieldValue(value, options) {
...
export function isPhoneValueEmpty(value, options) {
    return parsePhoneFieldValue(value, options).nationalNumber.length === 0;
}
export function phoneValueForValidation(value, options) {
