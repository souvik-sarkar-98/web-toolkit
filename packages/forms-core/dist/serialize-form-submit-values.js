 ...
 */
export function serializeFormSubmitValues(definition, values) {
    ...
    for (const [key, raw] of Object.entries(values)) {
        ...
        if (raw === null || raw === undefined)
            continue;
        if (raw === '' && field.fieldType !== 'boolean' && field.fieldType !== 'toggle')
            continue;
        if (field.fieldType === 'phone' && isPhoneValueEmpty(raw))
            continue;
...
//# sourceMappingURL=serialize-form-submit-values.js.map