...
function transformContent(content, relPath) {
  ...
  return content
    .replace(/from 'src\/app\/shared\/model\/key-value\.model'/g, "from '@ssweb-toolkit/list-dashboard-core'")
    .replace(/from 'src\/app\/shared\/model\/document\.model'/g, "from '@ssweb-toolkit/list-dashboard-core'")
    .replace(/from 'src\/app\/shared\/components\/generic\/file-upload\/file-upload\.component'/g, "from '@ssweb-toolkit/list-dashboard-core'")
    .replace(/from 'src\/app\/shared\/utils\/mobile-sheet-body-lock'/g, `from '${upToLib}utils/mobile-sheet-body-lock.js'`)
    .replace(/from '\.\/infinite-list\.model'/g, "from '@ssweb-toolkit/list-dashboard-core'")
    .replace(/from '\.\.\/infinite-list\.model'/g, "from '@ssweb-toolkit/list-dashboard-core'")
    .replace(/from '\.\.\/\.\.\/infinite-list\.model'/g, "from '@ssweb-toolkit/list-dashboard-core'")
    .replace(/from '\.\/list-detail\.model'/g, "from '@ssweb-toolkit/list-dashboard-core'")
    .replace(/from '\.\.\/list-detail\.model'/g, "from '@ssweb-toolkit/list-dashboard-core'")
    .replace(/from '\.\.\/\.\.\/list-detail\.model'/g, "from '@ssweb-toolkit/list-dashboard-core'")
    .replace(/from '\.\/list-detail\.helpers'/g, "from '@ssweb-toolkit/list-dashboard-core'")
    .replace(/from '\.\.\/list-detail\.helpers'/g, "from '@ssweb-toolkit/list-dashboard-core'")
    .replace(/from '\.\/filtered-list-page\.config'/g, "from '@ssweb-toolkit/list-dashboard-core'")
    .replace(/from '\.\/filtered-list-dashboard\.config'/g, "from '@ssweb-toolkit/list-dashboard-core'")
    .replace(/from '\.\/list-detail-page\.config'/g, "from '@ssweb-toolkit/list-dashboard-core'")
    .replace(/from '\.\/list-detail-page\.adapter'/g, "from '@ssweb-toolkit/list-dashboard-core'")
    .replace(/from '\.\/list-page\.adapter'/g, "from '@ssweb-toolkit/list-dashboard-core'")
    .replace(/from '\.\/create-list-page\.adapter'/g, "from '@ssweb-toolkit/list-dashboard-core'")
    .replace(/from '\.\/create-detail-page\.adapter'/g, "from '@ssweb-toolkit/list-dashboard-core'")
    .replace(/from '\.\/derive-bulk-edit-from-detail-edit\.util'/g, "from '@ssweb-toolkit/list-dashboard-core'")
    .replace(/from '\.\/merge-filter-form-definition\.util'/g, "from '@ssweb-toolkit/list-dashboard-core'")
    .replace(/from '\.\/list-route-query\.util'/g, "from '@ssweb-toolkit/list-dashboard-core'")
    .replace(/from '\.\/route-resolver\.util'/g, "from '@ssweb-toolkit/list-dashboard-core'")
