# @ssfrontend-toolkit/list-dashboard-core
...
```bash
npm install @ssfrontend-toolkit/forms-core @ssfrontend-toolkit/list-dashboard-core
```

Depends on `@ssfrontend-toolkit/forms-core` for form definitions used in list create/edit/filter.
...
`<na-list-dashboard>` in `@ssfrontend-toolkit/list-dashboard-angular`.
...
```bash
npm run build -w @ssfrontend-toolkit/list-dashboard-core
npm test -w @ssfrontend-toolkit/list-dashboard-core
```

## Consumers

- [`@ssfrontend-toolkit/list-dashboard-angular`](../list-dashboard-angular/README.md) — Angular host
- `@ssfrontend-toolkit/list-dashboard-react` — planned
