...
import type { ListPreparationTask, ListPreparationTrigger } from '../runtime/list-preparation.runtime.js';
...
export type ListActionRunTarget = 'openCreate' | 'openBulkEdit' | 'enterEdit'
/** Opens the detail sheet already in edit mode; usable from row actions. */
 | 'openDetailEdit' | 'openDetail' | (string & {});
export interface ListActionDef {
     ...
     */
    icon?: string;
    when?: (context: FilteredListDashboardContext & {
        selection: unknown[];
        entity?: unknown;
    }) => boolean;
...
export interface ListDashboardConfig<TEntity, TCriteria extends ListFilterCriteria, TContext = unknown, TOperations extends ListDashboardOperations = ListDashboardOperations> {
    list: FilteredListPageConfig<TCriteria> & {
        mapToListRow?: (entity: TEntity, ctx: {
            refData: RefDataMap;
            context: TContext;
        }) => ListRowItem<TEntity>;
    };
...
export interface ResolvedListDashboardConfig<TEntity, TCriteria extends ListFilterCriteria, TContext = unknown, TOperations extends ListDashboardOperations = ListDashboardOperations> {
    definition: ListDashboardConfig<TEntity, TCriteria, TContext, TOperations>;
    forms: Readonly<Record<string, ResolvedListForm>>;
}
//# sourceMappingURL=list-dashboard.config.d.ts.map