...
import { ListDetailEditContext, ListDetailSaveContext, ListDetailPageAdapter } from '../adapters/list-detail-page.adapter.js';
import type { ListFormFlowKind, ListFormStepperHooks } from './list-form-flow.config.js';
...
export interface ListDetailEditPageConfig<TEntity> extends ListFormStepperHooks<ListDetailEditContext<TEntity>> {
    /** Defaults to `form`. */
    ...
    onEditValuesChange?: (context: ListDetailEditContext<TEntity>, values: FormValues, setFormValue?: (key: string, value: unknown) => void) => {
...
export interface ConfiguredDetailPageAdapter<TEntity> extends ListDetailPageAdapter<TEntity> {
    configure(context: ListDetailConfigContext): void;
}
export type { ListDetailEditContext, ListDetailSaveContext };
//# sourceMappingURL=list-detail-page.config.d.ts.map