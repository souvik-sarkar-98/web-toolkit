...
export type ListFormStepperResolveSteps<T extends string = string> = (values: FormValues) => T[];
...
export interface ListFormStepperHooks<TContext = unknown> {
    ...
    buildStepDefinition?: (stepId: string, values: FormValues, ctx: TContext) => FormDefinition;
    resolveSteps?: ListFormStepperResolveSteps;
    validateStep?: (stepId: string, values: FormValues, ctx: TContext) => string | undefined;
    /**
     ...
     */
    prepareStep?: (stepId: string, values: FormValues, ctx: TContext) => Promise<void> | void;
 ...
 */
export interface ListActionFormConfig<TEntity = unknown> extends ListFormStepperHooks<ListActionFormContext<TEntity>> {
    ...
    onValuesChange?: (entity: TEntity, values: FormValues, ctx: {
        refData: RefDataMap;
        setFormValue?: (key: string, value: unknown) => void;
        preparationContext?: unknown;
    }) => ListActionFormValuesChangeResult | void | Promise<ListActionFormValuesChangeResult | void> | Observable<ListActionFormValuesChangeResult | void>;
...
//# sourceMappingURL=list-form-flow.config.d.ts.map