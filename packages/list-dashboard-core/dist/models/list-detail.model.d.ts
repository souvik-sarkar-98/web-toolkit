...
export type ListDetailSection = ListDetailKeyValueSection | ListDetailDocumentsSection | ListDetailContentSection | ListDetailItemListSection;
export type ListDetailSheetMode = 'view' | 'edit';
//# sourceMappingURL=list-detail.model.d.ts.map