...
export interface FilteredListPageAdapter<TCriteria extends ListFilterCriteria = ListFilterCriteria> {
    ...
    buildCriteriaFromRoute?(chipId: string, routeFilters: Record<string, unknown>, routeState: ListRouteState): TCriteria;
    buildFilterFormDefinition(chipId: string, refData: RefDataMap, criteria: TCriteria): FormDefinition;
    /** Preserve dynamic field options when chip unchanged. Return `next` to replace entirely. */
    mergeFilterFormDefinition?(current: FormDefinition | undefined, next: FormDefinition): FormDefinition;
...
//# sourceMappingURL=list-page.adapter.d.ts.map