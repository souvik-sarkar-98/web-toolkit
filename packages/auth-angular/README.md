...
```bash
npm install @web-toolkit/auth-core @web-toolkit/auth-angular
```
...
import { authGuard, permissionGuard } from '@web-toolkit/auth-angular';
...
```bash
npm run build -w @web-toolkit/auth-angular
npm test -w @web-toolkit/auth-angular
```
